...
import { PoolDataService, SubgraphPoolBase, TokenPriceService, SwapInfo, SOR, WeightedPool as WeightedPool$1, StablePool, LinearPool, MetaStablePool, PhantomStablePool, ComposableStablePool, SwapTypes, SwapV2 } from '@balancer-labs/sor';
...
import { Provider, JsonRpcProvider, Listener, JsonRpcSigner, TransactionRequest } from '@ethersproject/providers';
import { Event, EventFilter, BaseContract, Signer as Signer$1, BytesLike, Overrides, ContractTransaction, CallOverrides, BigNumber as BigNumber$1, PopulatedTransaction, BigNumberish as BigNumberish$1, utils, PayableOverrides } from 'ethers';
 ...
 */
declare class PoolsSubgraphOnChainRepository implements Findable<Pool$1, PoolAttribute>, Searchable<Pool$1> {
     ...
     */
    constructor(poolsSubgraph: PoolsSubgraphRepository, options: PoolsSubgraphOnChainRepositoryOptions, poolsToIgnore: string[] | undefined);
    private filterPools;
    /**
     * We need a list of all the pools, for calculating APRs (nested pools), and for SOR (path finding).
     * All the pools are fetched on page load and cachced for speedy lookups.
...
declare const getEthValue: (tokens: string[], amounts: string[]) => BigNumber | undefined;
...
interface PoolWithMethods extends Pool$1, ParamsBuilder {
    ...
    buildExitExactBPTIn: (exiter: string, bptIn: string, slippage: string, shouldUnwrapNativeAsset?: boolean, singleTokenOut?: string) => ExitExactBPTInAttributes;
    buildExitExactTokensOut: (exiter: string, tokensOut: string[], amountsOut: string[], slippage: string) => ExitExactTokensOutAttributes;
    buildRecoveryExit: (exiter: string, bptIn: string, slippage: string) => ExitExactBPTInAttributes;
...
interface BalancerHelpers extends BaseContract {
    ...
    functions: {
        queryExit(poolId: PromiseOrValue<BytesLike>, sender: PromiseOrValue<string>, recipient: PromiseOrValue<string>, request: IVault$2.ExitPoolRequestStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        queryJoin(poolId: PromiseOrValue<BytesLike>, sender: PromiseOrValue<string>, recipient: PromiseOrValue<string>, request: IVault$2.JoinPoolRequestStruct, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    vault(overrides?: CallOverrides): Promise<string>;
    callStatic: {
        queryExit(poolId: PromiseOrValue<BytesLike>, sender: PromiseOrValue<string>, recipient: PromiseOrValue<string>, request: IVault$2.ExitPoolRequestStruct, overrides?: CallOverrides): Promise<[
            BigNumber$1,
            BigNumber$1[]
        ] & {
            bptIn: BigNumber$1;
        ...
        queryJoin(poolId: PromiseOrValue<BytesLike>, sender: PromiseOrValue<string>, recipient: PromiseOrValue<string>, request: IVault$2.JoinPoolRequestStruct, overrides?: CallOverrides): Promise<[
            BigNumber$1,
            BigNumber$1[]
        ] & {
            bptOut: BigNumber$1;
...
interface WeightedPool extends BaseContract {
    ...
    populateTransaction: {
        ...
        onSwap(request: IPoolSwapStructs.SwapRequestStruct, balanceTokenIn: PromiseOrValue<BigNumberish$1>, balanceTokenOut: PromiseOrValue<BigNumberish$1>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        permit(owner: PromiseOrValue<string>, spender: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish$1>, deadline: PromiseOrValue<BigNumberish$1>, v: PromiseOrValue<BigNumberish$1>, r: PromiseOrValue<BytesLike>, s: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
...
interface WeightedPoolFactoryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "create" | "getPauseConfiguration" | "getVault" | "isPoolFromFactory"): FunctionFragment;
...
interface WeightedPoolFactory extends BaseContract {
    ...
    removeListener: OnEvent<this>;
    functions: {
        create(name: PromiseOrValue<string>, symbol: PromiseOrValue<string>, tokens: PromiseOrValue<string>[], weights: PromiseOrValue<BigNumberish$1>[], swapFeePercentage: PromiseOrValue<BigNumberish$1>, owner: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    isPoolFromFactory(pool: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        create(name: PromiseOrValue<string>, symbol: PromiseOrValue<string>, tokens: PromiseOrValue<string>[], weights: PromiseOrValue<BigNumberish$1>[], swapFeePercentage: PromiseOrValue<BigNumberish$1>, owner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        getPauseConfiguration(overrides?: CallOverrides): Promise<[
            BigNumber$1,
            BigNumber$1
        ] & {
...
declare class BalancerHelpers__factory {
    ...
    static connect(address: string, signerOrProvider: Signer$1 | Provider): BalancerHelpers;
}
...
declare class LidoRelayer__factory {
    ...
    static connect(address: string, signerOrProvider: Signer$1 | Provider): LidoRelayer;
}
...
declare class Vault__factory {
    ...
    static connect(address: string, signerOrProvider: Signer$1 | Provider): Vault;
}
...
declare class WeightedPool__factory {
    ...
    static connect(address: string, signerOrProvider: Signer$1 | Provider): WeightedPool;
}
...
declare class WeightedPoolFactory__factory {
    ...
    static connect(address: string, signerOrProvider: Signer$1 | Provider): WeightedPoolFactory;
}
...
declare class PoolGraph {
    private pools;
    constructor(pools: Findable<Pool$1, PoolAttribute>);
    buildGraphFromRootPool(poolId: string): Promise<Node>;
    getTokenTotal(pool: Pool$1): BigNumber;
    buildGraphFromPool(address: string, nodeIndex: number, parent: Node | undefined, proportionOfParent: BigNumber): Promise<[Node, number]>;
    createLinearNodeChildren(linearPoolNode: Node, nodeIndex: number, linearPool: Pool$1): [Node, number];
    static createInputTokenNode(nodeIndex: number, address: string, decimals: number, parent: Node | undefined, proportionOfParent: BigNumber): [Node, number];
    static orderByBfs(root: Node): Node[];
    static getLeafAddresses(nodes: Node[]): string[];
    getGraphNodes: (isJoin: boolean, poolId: string) => Promise<Node[]>;
}
...
declare class Simulation {
    ...
    simulateGeneralisedJoin: (to: string, multiRequests: Requests[][], encodedCall: string, outputIndexes: number[], userAddress: string, tokensIn: string[], signer: JsonRpcSigner, simulationType: SimulationType) => Promise<string[]>;
...
declare class Exit {
    ...
    private relayer;
    constructor(poolGraph: PoolGraph, networkConfig: BalancerNetworkConfig, simulationService: Simulation);
    exitPool(poolId: string, amountBptIn: string, userAddress: string, slippage: string, signer: JsonRpcSigner, simulationType: SimulationType, authorisation?: string): Promise<{
        to: string;
        encodedCall: string;
        tokensOut: string[];
        expectedAmountsOut: string[];
...
declare class Pools implements Findable<PoolWithMethods> {
     ...
     */
    generalisedExit(poolId: string, amount: string, userAddress: string, slippage: string, signer: JsonRpcSigner, simulationType: SimulationType, authorisation?: string): Promise<{
        to: string;
        encodedCall: string;
        tokensOut: string[];
        expectedAmountsOut: string[];
...
export { AMP_PRECISION, APR_THRESHOLD, AaveHelpers, AaveRates, Account, Address$1 as Address, AprBreakdown, AprFetcher, AssetHelpers, BalancerAPIArgsFormatter, BalancerDataRepositories, BalancerError, BalancerErrorCode, BalancerErrors, BalancerHelpers, BalancerHelpers__factory, BalancerMinterAuthorization, BalancerNetworkConfig, BalancerSDK, BalancerSDKRoot, BalancerSdkConfig, BalancerSdkSorConfig, BalancerTenderlyConfig, BaseFeeDistributor, BasePoolEncoder, BatchSwap, BatchSwapStep, BlockNumberRepository, BuildTransactionParameters, CoingeckoHistoricalPriceRepository, CoingeckoPriceRepository, ComposableStablePoolEncoder, ComposableStablePoolExitKind, ComposableStablePoolJoinKind, ContractAddresses, Currency, Data, Debouncer, EncodeBatchSwapInput, EncodeExitPoolInput, EncodeJoinPoolInput, EncodeUnwrapAaveStaticTokenInput, EncodeWrapAaveDynamicTokenInput, ExitAndBatchSwapInput, ExitPoolData, ExitPoolRequest$1 as ExitPoolRequest, FeeCollectorRepository, FeeDistributorData, FeeDistributorRepository, FetchPoolsInput, FindRouteParameters, Findable, FundManagement, GaugeControllerMulticallRepository, GaugeShare, GaugeShareAttributes, GaugeSharesRepository, GraphQLArgs, GraphQLArgsBuilder, GraphQLArgsFormatter, GraphQLFilter, GraphQLFilterOperator, GraphQLQuery, HistoricalPriceProvider, HistoricalPrices, IAaveRates, JoinPoolData, JoinPoolRequest$1 as JoinPoolRequest, LidoRelayer, LidoRelayer__factory, Liquidity, LiquidityGauge, LiquidityGaugeSubgraphRPCProvider, LiquidityGaugesMulticallRepository, LiquidityGaugesSubgraphRepository, ManagedPoolEncoder, NamedPools, Network, OnchainPoolData, OnchainTokenData, OutputReference, POOLS, Pool$1 as Pool, PoolAttribute, PoolBPTValue, PoolBalanceOp, PoolBalanceOpKind, PoolGauges, PoolGaugesAttributes, PoolGaugesRepository, PoolJoinExit, PoolJoinExitAttributes, PoolJoinExitRepository, PoolReference, PoolRepository, PoolShare, PoolShareAttributes, PoolSharesRepository, PoolSpecialization, PoolToken, PoolType, PoolWithMethods, Pools, PoolsBalancerAPIRepository, PoolsFallbackRepository, PoolsFallbackRepositoryOptions, PoolsRepositoryFetchOptions, PoolsStaticRepository, PoolsSubgraphOnChainRepository, PoolsSubgraphRepository, Price, PriceRateProvider, ProtocolFees, ProtocolFeesProvider, QuerySimpleFlashSwapParameters, QuerySimpleFlashSwapResponse, QueryWithSorInput, QueryWithSorOutput, Relayer, RelayerAction, RelayerAuthorization, RewardData, SHALLOW_COMPOSABLE_STABLE_BUFFER, Searchable, SimpleFlashSwapParameters, SimulationType, SingleSwap, Sor, StablePhantomPoolJoinKind, StablePoolEncoder, StablePoolExitKind, StablePoolJoinKind, StaticTokenPriceProvider, StaticTokenProvider, SubPool, SubPoolMeta, Subgraph, SubgraphArgsFormatter, SubgraphPriceRepository, Swap, SwapAttributes, SwapInput, SwapTransactionRequest, SwapType, Swaps, Token, TokenAttribute, TokenPriceProvider, TokenPrices$1 as TokenPrices, TokenProvider, TokenYieldsRepository, TransactionData, UserBalanceOp, UserBalanceOpKind, Vault, Vault__factory, WeightedPool, WeightedPoolEncoder, WeightedPoolExitKind, WeightedPoolFactory, WeightedPoolFactory__factory, WeightedPoolJoinKind, WeightedPool__factory, accountToAddress, addressMapIn, emissions as balEmissions, bn, buildRelayerCalls, canUseJoinExit, index as factories, formatFixed, formatFromBigInt18, getEthValue, getLimitsForSlippage, getPoolAddress, getPoolNonce, getPoolSpecialization, insert, isLinearish, isNormalizedWeights, isSameAddress, parseFixed, parsePoolInfo, parseToBigInt18, removeItem, reorderArrays, replace, signPermit, someJoinExit, splitPoolId, toNormalizedWeights, tokenAddressForPricing, tokensToTokenPrices, truncateAddresses, unwrapToken };
