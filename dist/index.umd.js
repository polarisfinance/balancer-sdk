(function (global, factory) {
    ...
    (function (Network) {
        ...
        Network[Network["AURORA"] = 1313161554] = "AURORA";
        Network[Network["AURORATEST"] = 1313161555] = "AURORATEST";
    ...
    const BALANCER_NETWORK_CONFIG = {
        ...
        [exports.Network.AURORA]: {
            chainId: exports.Network.AURORA,
            addresses: {
                contracts: {
            ...
            urls: {
                subgraph: 'https://api.thegraph.com/subgraphs/name/polarisfinance/polaris-dex',
            },
            pools: {},
        },
        [exports.Network.AURORATEST]: {
            chainId: exports.Network.AURORATEST,
            addresses: {
                contracts: {
            ...
            urls: {
                subgraph: 'https://api.thegraph.com/subgraphs/name/polarisfinance/polaris-dex-testnet',
            },
            pools: {},
        },
    };
    ...
    class StablePoolJoin {
        constructor() {
            ...
            this.buildJoin = ({ joiner, pool, tokensIn, amountsIn, slippage, wrappedNativeAsset, }) => {
                ...
                const expectedBPTOut = SDK__namespace.StableMath._calcBptOutGivenExactTokensIn(new OldBigNumber__default["default"](parsedAmp), sortedBalances.map((b) => new OldBigNumber__default["default"](b)), sortedAmounts.map((a) => new OldBigNumber__default["default"](a)), new OldBigNumber__default["default"](parsedTotalShares), new OldBigNumber__default["default"](parsedSwapFee)).toString();
        ...
        constructor() {
            ...
            this.buildExitExactBPTIn = ({ exiter, pool, bptIn, slippage, shouldUnwrapNativeAsset, wrappedNativeAsset, singleTokenMaxOut, }) => {
                ...
                if (singleTokenMaxOut) {
                    ...
                    const amountsOut = SDK__namespace.WeightedMath._calcTokensOutGivenExactBptIn(sortedBalances.map((b) => new OldBigNumber__default["default"](b)), new OldBigNumber__default["default"](bptIn), new OldBigNumber__default["default"](parsedTotalShares)).map((amount) => amount.toString());
                    // Apply slippage
            ...
            this.buildExitExactTokensOut = ({ exiter, pool, tokensOut, amountsOut, slippage, wrappedNativeAsset, }) => {
                ...
                const bptIn = SDK__namespace.WeightedMath._calcBptInGivenExactTokensOut(sortedBalances.map((b) => new OldBigNumber__default["default"](b)), sortedWeights.map((w) => new OldBigNumber__default["default"](w)), sortedAmounts.map((a) => new OldBigNumber__default["default"](a)), new OldBigNumber__default["default"](parsedTotalShares), new OldBigNumber__default["default"](parsedSwapFee)).toString();
                // Apply slippage
    ...
    class MetaStablePoolJoin {
        constructor() {
            ...
            this.buildJoin = ({ joiner, pool, tokensIn, amountsIn, slippage, wrappedNativeAsset, }) => {
                ...
                const expectedBPTOut = SDK__namespace.StableMath._calcBptOutGivenExactTokensIn(new OldBigNumber__default["default"](parsedAmp), scaledBalances.map((b) => new OldBigNumber__default["default"](b)), scaledAmounts.map((a) => new OldBigNumber__default["default"](a)), new OldBigNumber__default["default"](parsedTotalShares), new OldBigNumber__default["default"](parsedSwapFee)).toString();
                const minBPTOut = subSlippage(bignumber.BigNumber.from(expectedBPTOut), bignumber.BigNumber.from(slippage)).toString();
                const userData = StablePoolEncoder.joinExactTokensInForBPTOut(sortedAmounts, minBPTOut);
                const to = balancerVault;
                const functionName = 'joinPool';
